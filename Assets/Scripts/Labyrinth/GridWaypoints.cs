 ...
 *    - Crea unha grella (rejilla) bidimensional de nodos
...
public class GridWaypoints : MonoBehaviour
{
    ...
    /*
     * MÉTODO GET ADJACENT NODES - CÁLCULO DE NODOS ADXACENTES
     * ======================================================
     * 
    ...
    /*
     * SOBRECARGA DE GET ADJACENT NODES
    ...
    /*
     * MÉTODO IS VALID POSITION - VALIDACIÓN DE COORDENADAS
     * ==================================================
     * 
    ...
    /*
     * MÉTODO INITIALIZE GRID - CONFIGURACIÓN DA GRELLA DE NAVEGACIÓN
     * =============================================================
     * 
    ...
    /*
     * MÉTODO CREATE GRID FROM PATTERN - CREACIÓN DA ESTRUTURA DE DATOS
     * =============================================================
     * 
    ...
    /*
     * MÉTODO INITIALIZE WAYPOINTS AND NEIGHBORS - CONFIGURACIÓN VISUAL E CONEXIÓNS
     * ========================================================================
     * 
    ...
    /*
     * MÉTODO CREATE WAYPOINT - CREACIÓN DE WAYPOINTS VISUAIS
     * =====================================================
     * 
    ...
    /*
     * MÉTODO SET WAYPOINT MATERIAL - CONFIGURACIÓN VISUAL DE NODOS
     * ==========================================================
     * 
    ...
    /*
     * MÉTODO SETUP START AND END NODES - CONFIGURACIÓN DE PUNTOS ESPECIAIS
     * ================================================================
     * 
    ...
    /*
     * MÉTODO MOVE TO START POSITION - POSICIONAMENTO INICIAL
     * ==================================================
     * 
